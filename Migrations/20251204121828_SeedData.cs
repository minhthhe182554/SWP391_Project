...
namespace SWP391_Project.Migrations
{
    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Jobs",
                columns: new[] { "Id", "CompanyId", "Description", "EndDate", "HigherSalaryRange", "IsDelete", "LocationId", "LowerSalaryRange", "StartDate", "Title", "Type", "VacancyCount", "WorkTime", "YearsOfExperience" },
                values: new object[] { 1, 1, "Tham gia phát triển dự án Banking...", new DateTime(2026, 1, 3, 19, 18, 27, 683, DateTimeKind.Local).AddTicks(5062), 30000000m, false, 1, 15000000m, new DateTime(2025, 12, 4, 19, 18, 27, 683, DateTimeKind.Local).AddTicks(5051), "Tuyển dụng Senior .NET Developer", 0, 5, "Full-time (T2-T6)", 2 });
        }
